...
! ---- destination_locs=n_b,  weight_locs=n_s ----------------
  ...
  integer, parameter           :: destination_locs      = 1179648
  integer, parameter           :: weight_locs           = 1686556

  integer, parameter           :: destination_lats      = 768
  integer, parameter           :: destination_lons      = 1536
